...
app.directive('message', function($interpolate){ //helps to manually evaluate scope values
    return{
        compile: function(tElement, tAttributes){
            ...
            return {
                ...
                post:function(scope, iElement, iAttributes){ /////////////// manipulating DOM in post phase of compiling
